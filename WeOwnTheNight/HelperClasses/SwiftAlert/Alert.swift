...
class Alert: NSObject {
    ...
    class func showTostMessage(message:String, delay:Double, controller:UIViewController!)
    {
        ...
        controller.PRESENT_VC(vc: alert, animated: true)
...
//    }
  ...
  class func createRequestBodyWith(parameters:[String:NSObject], filePathKey:String, boundary:String,fileName:NSString,image:UIImage) -> NSData{
   ...
   class func CONFIG_NAVIGATION_STPOPUP(){
        ...
        STPopupNavigationBar.appearance().titleTextAttributes = [NSForegroundColorAttributeName:UIColor.white,NSFontAttributeName: UIFont(name:FONT.kFONT_MEDIUM , size: 16)!]
    }
    ...
    class func LOGO() -> UIBarButtonItem {
        
        let barButtonHome:UIBarButtonItem! = UIBarButtonItem(image: #imageLiteral(resourceName: "app_icon_white") , style: .plain, target: self, action: #selector(Alert.barButtonLogoClick))
    ...
    class func barButtonLogoClick(){
        
        
    }
    
    // MARK: - HOME button Click
   class func barButtonHomeClick() {
