...
extension UIViewController
{
    ...
    func setNavigationBar(title : String! , leftButton : String!   ) {

        self.navigationItem.title = title
        self.navigationController?.navigationBar.titleTextAttributes = [NSForegroundColorAttributeName: UIColor.white]
        let barButtonItem = UIBarButtonItem(image: UIImage(named: leftButton)?.withRenderingMode(.alwaysOriginal),
                                            style: .plain,
                                            target: self,
                                            action: nil)
...
extension UIButton
{
    func setCrnrRadius(_ amount:CGFloat){
