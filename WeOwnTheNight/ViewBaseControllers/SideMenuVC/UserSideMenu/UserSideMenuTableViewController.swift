//
//  UserSideMenuTableViewController.swift
//  WeOwnTheNight
//
...
class UserSideMenuTableViewController: UITableViewController {
    var arrList : NSArray! = ["user.png","menu","setting","navicalender","navinote","search-1" ]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            destViewController = mainStoryboard.instantiateViewController(withIdentifier: "UserTabBarViewController")
        ...
        case 4:
            ...
            break
        case 5:
            destViewController = mainStoryboard.instantiateViewController(withIdentifier: "SearchEventViewController") as! SearchEventViewController
            break
