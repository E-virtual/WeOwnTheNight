//
//  ClubListingViewController.swift
//  WeOwnTheNight
//
...
class ClubListingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.setNavigationBar(title: "CLUB LISTING",leftButton: "nav")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let viewController = storyboard.instantiateViewController(withIdentifier: "ClubProfileViewController") as! ClubProfileViewController
