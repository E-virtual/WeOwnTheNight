...
class EventBookingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.setNavigationBar(title: "EVENT BOOKING",leftButton: "nav")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let viewController = storyboard.instantiateViewController(withIdentifier: "EventBookingListViewController") as! EventBookingListViewController
